...
class WebhookDelivery(Base):
    ...
    __table_args__ = (
        ...
        Index(
            "ix_webhook_deliveries_pending", "status", "next_retry_at",
    ...
    next_retry_at: Mapped[datetime] = mapped_column(DateTime(timezone=True), nullable=False, default=lambda: datetime.now(timezone.utc))
